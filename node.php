<?php
	...
	include 'resources/library/functions.php'; 
				...
				$loginUrl = 'https://www.facebook.com/dialog/oauth?client_id='. $config["fbApp"]["appId"] .'&redirect_uri='. $config["urls"]["baseUrl"] .'/node.php&scope=nae,public_profile, email&response_type=code';
