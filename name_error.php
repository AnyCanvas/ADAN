...
<html lang="es">
	...
	<div class="container-fluid" style="height: 100%; width: 100%">
		<div class="red accent-2" style=" height: 75%; background-image: url(./images/error.png); background-repeat: no-repeat; background-position: center bottom; background-size: auto 60%;">
		</div>
