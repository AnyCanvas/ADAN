		  ...
		  <div class="fb_logo-row row">
		    ...
		    <div class="col-xs-4" >
			    <div class="center-block" >
					...
					$pictureJson = file_get_contents('https://graph.facebook.com/'. $_SESSION['config']['link'] .'/picture?access_token=1645165719040597|8WhElgl4UJakYjg4rVsu5bGaTNA&redirect=false&height=300');
