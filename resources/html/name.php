<body>
	...
	<div class="container-fluid" style="height: 100%; width: 100%">
	    ...
	    <footer style="height: 25%;">
		      ...
		      <input onfocus="$('#name-btn').show('slow'); $('p').css('background-color', 'yellow'); $('p').css('font-size', 'x-small !important');" onfocusout="$('#name-btn').hide('slow'); $('#p').show('slow');" name="name" id="fnbt-name-label" class="fnbt-name-input white-text"></input>
		      </form>
